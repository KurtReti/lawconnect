      ...
      <div className="highlightsContainer">
        ...
        <div className="highlights__cardsContainer">
          <Card
            ...
            content="LawConnect stores its data on servers provided by Amazon Web Services and is safer than email."
            img={card1}
          />
          <Card
            title="Work Remotely"
            content="You can sign in to LawConnect and view, collaborate and share your documents from anywhere.."
            img={card2}
          />
          <Card
            title="Greater Collaboration"
            content="Collaborate on documents with clients, lawyers and other parties with LawConnect’s Comment and Reply."
            img={card3}
          />
        </div>
      </div>
